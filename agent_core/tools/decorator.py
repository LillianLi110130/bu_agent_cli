...
from agent_core.llm.messages import ContentPartImageParam, ContentPartTextParam
from agent_core.llm.schema import SchemaOptimizer
from agent_core.tools.depends import Depends
...
class Tool:
    ...
    async def execute(self, _overrides: dict | None = None, **kwargs: Any) -> ToolContent:
        """
