...
某些工具结果在进入上下文时，可能只保留预览、摘要或裁剪后的内容；完整结果可能已经保存到运行时 artifact 文件中。

如果工具结果明确显示为 preview、summary、trimmed、`Context preview`、`Artifact file` 或其他类似提示，你必须理解这通常不是完整原始结果。
...
如果当前结果已经足以支持下一步推理、回答或修改，就直接继续，不要为了“看全”而默认展开 artifact 或重复读取。
