...
class SkillInfo(BaseModel):
    ...
    source: Literal["config", "database", "api"] = Field(
        ..., description="Where the skill was loaded from"
    )
...
class SkillByCategoryResponse(BaseModel):
    ...
    categories: dict[str, list[SkillInfo]] = Field(..., description="Skills grouped by category")
