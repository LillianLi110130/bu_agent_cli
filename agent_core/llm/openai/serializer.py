...
class OpenAIMessageSerializer:
    ...
    def _serialize_user_content(
        content: (
            str | list[ContentPartTextParam | ContentPartImageParam | ContentPartDocumentParam]
        ),
        ...
        for part in content:
            if part.type == "text":
                ...
                serialized_parts.append(
                    ChatCompletionContentPartTextParam(text="[PDF document attached]", type="text")
                )
    ...
    def _serialize_tool_message_content(
        ...
        for part in content:
            if part.type == "text":
                ...
                serialized_parts.append(
                    ChatCompletionContentPartTextParam(text="[Image attached]", type="text")
                )
    ...
    def serialize(message: BaseMessage) -> ChatCompletionMessageParam:
        ...
        if isinstance(message, UserMessage):
            ...
            if message.destroyed:
                ...
                content = OpenAIMessageSerializer._serialize_tool_message_content(message.content)
