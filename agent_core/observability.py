"""
Observability module for agent_core with optional Laminar (lmnr) integration.
...
Usage:
    from agent_core.observability import observe, observe_debug, Laminar
...
try:
    ...
    logger.debug("Laminar (lmnr) not installed - observability decorators will be no-ops")
    _LMNR_AVAILABLE = False
