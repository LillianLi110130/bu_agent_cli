...
function Copy-FilteredPythonLib {
    ...
    Copy-Item -LiteralPath $SourceLibDir -Destination $TargetLibDir -Recurse -Force
    ...
    Get-ChildItem -LiteralPath $TargetLibDir -Recurse -File -Include "*.pyc", "*.pyo" -ErrorAction SilentlyContinue |
...
$entryShimContent = @(
    'from claude_code import cli_main',
    '',
